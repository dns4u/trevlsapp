        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="{{ route('admin.user.update',$data['user']->id) }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="contact"  value="{{ old('contact',$data['user']->contact ) }}"  placeholder="Valid Phone" class="col-xs-10 col-sm-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="address" cols="30" rows="10" class="form-control">{{ old('address',$data['user']->address ) }}</textarea>
